...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        #抓取键
        self.bt_Catch= QtWidgets.QPushButton(Form)
        self.bt_Catch.setGeometry(QtCore.QRect(450, 70, 75, 23))
        self.bt_Catch.setObjectName("bt_Catch")
        self.bt_Catch.clicked.connect(self.mult_sport)
        #手势识别按键
        ...
        self.bt_track.setGeometry(QtCore.QRect(630, 70, 75, 23))
        ...
        self.bt_Catch.setEnabled(False)
    ...
    def retranslateUi(self, Form):
        ...
        self.bt_Catch.setText(_translate("Form", "物体抓取"))
